  ...
  try {
    ...
    try {
      awarded = checkAchievements(req.wallet, {
        ...
        exactHits: Number(clientStats.exactHits) || 0,
        totalQuestions: Number(clientStats.totalQuestions) || 0,
        roundsSurvived: Number(clientStats.roundsSurvived) || 0,
        perfectRounds: Number(clientStats.perfectRounds) || 0,
        consecutiveCorrect: Number(clientStats.consecutiveCorrect) || 0,
